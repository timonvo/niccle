...
/// Test data for use in example binaries.
pub mod example_data {
    ...
    //
    // Note that any changes to the frame data require changing the `_fcs` field value as well.
    ...
    /// A test Ethernet frame containing an ARP request asking for the MAC address of the device
    /// with link-local IPv4 address 169.254.172.115, sent by a device with MAC address
    /// 12:34:56:78:90:12 (a "locally-administered" address) and IPv4 address 169.254.172.114.
